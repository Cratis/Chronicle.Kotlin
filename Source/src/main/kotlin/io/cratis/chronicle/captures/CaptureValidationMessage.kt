...
/**
 * Something the kernel has to say about a capture declaration.
 *
 ...
 */
data class CaptureValidationMessage(
    val message: String,
    val line: Int,
    val column: Int
) {
    /** The message as `line:column: message`, which is what you want in a log or an editor gutter. */
