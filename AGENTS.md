# Chronicle.Kotlin — Project Instructions

## Repository scope and rule routing

Framework/client profile: this is the Chronicle JVM client for Kotlin and Java, not a C# event-sourced application. Use its existing Gradle/JVM checks and do not impose unrelated .NET/React conventions.
